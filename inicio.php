<style>
	...
	.btn{
				...
				<br>
					<button type="button" class="btn btn-info btn-lg btn-block verificar"><span class="glyphicon glyphicon-send" aria-hidden="true"></span> Verificar Constancia</button>
					<br>
