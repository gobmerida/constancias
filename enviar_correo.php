<?php
	//Create a new PHPMailer instance
		...
		$mail->Username = "contactorrhh.gobmerida@gmail.com";
		//Password to use for SMTP authentication
		$mail->Password = "go8mer1da";
		...
		$mail->Body    = 'Se ha registrado exitosamente en el sistema de Constancias y Recibos de pago, su contraseña es: '.$_POST["clave"]. '. <br>Por favor no responda este correo ya que es generado automáticamente por el sistema';
		$mail->AltBody = 'probandosss';
		$mail->CharSet = 'UTF-8';
		//Attach an image file
		//send the message, check for errors
		if (!$mail->send()) {
		    echo "<script>alert('Se ha registrado satisfactoriamente, pero ha ocurrido un error y no se le enviara por correo la información de registro en el sistema;</script>". ": " . $mail->ErrorInfo;
		} else {
